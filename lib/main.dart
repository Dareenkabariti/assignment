...
import 'package:sql_assignment02/task_model.dart';
          ...
          children: [
            UserAccountsDrawerHeader(
                currentAccountPicture:
                    CircleAvatar(child: Text("T".toUpperCase())),
            ...
            ListTile(
              ...
              subtitle: Text('All users Complete task '),
              trailing: Icon(Icons.arrow_right),
            ),
            ListTile(
              onTap: () {
              ...
              subtitle: Text('All users Incomplete task '),
              trailing: Icon(Icons.arrow_right),
            ),
          ],
        ),
                        ...
                        showDialog(
                          ...
                          builder: (context) {
                            return Center(
                              ...
                              title: Text("Alert"),
                              content: Text(
                                  "You Will Delete A Task , are you \n sure? "),
                              actions: <Widget>[
                                FlatButton(
                                  child: Text("Ok"),
                                  onPressed: () {
